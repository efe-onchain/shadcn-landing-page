  ...
  return (
    <article className="text-white select-none">
      <div className="prose prose-lg mx-auto p-8">
        ...
        <ul>
          <li>
            <strong>Essential Technologies:</strong> To maintain the security of our Services and your account, prevent
        ...
        <p>
          If you access our Services from outside the United States, your information may be transferred to, stored, and
          processed by us and our third-party service providers in:
        </p>
        <ul>
          <li>United States</li>
          <li>Taiwan</li>
